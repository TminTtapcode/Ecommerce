    ...
    <header className="bg-gradient-to-b from-orange-500 to-orange-600 text-white shadow-md z-50 sticky top-0">
      <div className="container mx-auto px-4 max-w-7xl h-8 flex items-center justify-between text-sm font-medium">
        <div className="flex items-center space-x-4">
          ...
          <Link to="#" className="hover:text-white/80 transition-colors">Tải ứng dụng</Link>
          <span className="w-px h-3 bg-white/30"></span>
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-1 cursor-pointer transition-colors relative">
            {isAuthenticated ? (
              <NotificationDropdown iconClassName="w-4 h-4" />
            ) : (
            ...
            <span className="hover:text-white/80">Thông Báo</span>
          </div>
